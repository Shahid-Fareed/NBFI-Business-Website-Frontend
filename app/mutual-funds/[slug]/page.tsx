...
import FundFacts from "@/app/components/products/fundFacts";
...
import ProductObjective from "@/app/components/products/productObjective";
        ...
        <div style={{ backgroundImage: "url('/assets/background-repeat1.png')" }}>
            ...
            >
                <div className="container pb-8">
                    ...
                    <FundFacts  Slug={data.product.slug || ""} Productcode={data.product.productcode || ""} Factscard={data.product.fundfact || []} FileCategory={data.product.downloadcategory || [] } />
