    ...
    return (
        <>
            <div className='container md:px-0 px-4'>
                <div className='border border-[#CFDAF3] rounded-xl p-7 mt-10 mb-10 bg-[#F2F6FF] '>
                    <h2 className='text-3xl sm:text-4xl text-primary font-normal heading-title color-green'
                        dangerouslySetInnerHTML={{ __html: i18n.language === 'en' ? sectionData?.title : sectionData?.urdu_urdu }}
                    >
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-4 gap-5 -mx-3">
